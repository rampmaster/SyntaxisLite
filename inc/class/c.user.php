...
class tsUser {
    ...
    var $is_admod = 0;
    var $is_banned = 0;
	var $nick = 'Anonimo';// NOMBRE A MOSTRAR
	var $uid = 0;			// USER ID
	...
	*/
	function loginUser($username, $password, $remember = FALSE, $redirectTo = NULL){
      ...
      if (filter_var($username, FILTER_VALIDATE_EMAIL)) $email = true;
		else $pp_password = md5(md5($password) . $username);
		/* CONSULTA */
