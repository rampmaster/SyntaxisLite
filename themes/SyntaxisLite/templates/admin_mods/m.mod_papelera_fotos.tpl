								...
								<table cellpadding="0" cellspacing="0" border="0" class="table table-striped" width="100%" align="center">
									...
									<tbody>
										...
										<tr id="report_{$f.foto_id}">
											...
											<td><a href="{$tsConfig.url}/perfil/{$f.user_name}" data-vcard="{$f.user_id}">{$f.user_name}</a></td>
											<td><a href="{$tsConfig.url}/perfil/{$f.mod_name}" data-vcard="{$f.mod}">{$f.mod_name}</a></td>
