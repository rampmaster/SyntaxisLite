								...
								<div id="res" class="boxy-content">
									...
									<form action="" method="post">
										...
										<input type="submit" name="buscar" value="Buscar Contenido" class="btn btn-success"/>
									</form>
									{elseif $tsAct == 'search'}
									<form action="" method="post">
									...
									<hr class="separator" />
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" width="100%" align="center" id="usuarios">
                                    	<thead>
                                        	<th>Usuario</th>
											<th>IP</th>
											<th>Fecha</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="{$tsConfig.url}/perfil/{$u.user_name}" data-vcard="{$u.user_id}">{$u.user_name}</a></td>
									...
									<hr class="separator" />
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped" width="100%" align="center" id="muro">
                                    	<thead>
                                        	<th>Autor</th>
											<th>Contenido</th>
											<th>IP</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="{$tsConfig.url}/perfil/{$m.user_name}" data-vcard="{$m.user_id}">{$m.user_name}</a></td>
                                                <td>{$m.p_body}</td>
									...
									<hr class="separator" />
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" width="100%" align="center" id="posts">
                                    	<thead>
                                        	<th>Post</th>
											<th>Autor</th>
											<th>IP</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="report_{$r.obj_id}">
												...
												<td><a href="{$tsConfig.url}/perfil/{$p.user_name}" data-vcard="{$p.post_user}">{$p.user_name}</a></td>
									...
									<hr class="separator" />
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" width="100%" align="center" id="fotos">
                                    	<thead>
                                        	<th>Foto</th>
											<th>Autor</th>
											<th>IP</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
												...
												<td><a href="{$tsConfig.url}/perfil/{$f.user_name}" data-vcard="{$f.f_user}">{$f.user_name}</a></td>
									...
									<hr class="separator" />
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" width="100%" align="center" id="p_comentarios">
                                    	<thead>
                                        	<th>Comentario</th>
											<th>Autor</th>
											<th>IP</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="comentario_{$c.cid}">
												...
												<td><a href="{$tsConfig.url}/perfil/{$c.user_name}" data-vcard="{$c.c_user}">{$c.user_name}</a></td>
									...
									<hr class="separator" />
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" width="100%" align="center" id="f_comentarios">
                                    	<thead>
                                        	<th>Comentario</th>
											<th>Foto</th>
											<th>Autor</th>
