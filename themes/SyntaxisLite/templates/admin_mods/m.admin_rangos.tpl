                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" width="400" align="center">
                                	<thead>
                                    	<th>Rango</th>
                                        <th>Usuarios</th>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped" width="550" align="center">
                                	<thead>
				...
				<input type="button" id="b2" onclick="$('#tab2').show('slow'); $('#tab1').hide('slow'); $(this).css('border','1px solid #4D90FE'); $('#b1').css('border','0px');" value="Permisos" style="width:100px;cursor:default;" class="mBtn btnYellow"/> 
                                    ...
                                    <hr />
									<input type="button" onclick="$('#tab2').show('slow'); $('#tab1').hide('slow'); $('#b2').css('border','1px solid #4D90FE'); $('#b1').css('border','0px');" value="Continuar" style="width:100px;cursor:default;" class="btn btn-success"/> 
									</div>									
