		...
		<tbody>
			...
			<tr>
				...
				<td class="admin_actions">
					<a href="{$tsConfig.url}/admin/news/editar/{$n.not_id}" title="Editar"><i feather="edit-3"></i></a>
					<a onclick="admin.news.accion({$n.not_id}); return false" title="Activar/Desactivar Noticia"><i feather="refresh-ccw"></i></a>
					<a href="{$tsConfig.url}/admin/news?act=borrar&nid={$n.not_id}" title="Borrar"><i feather="trash"></i></a>
				</td>
			</tr>
			{/foreach}
		</tbody>
