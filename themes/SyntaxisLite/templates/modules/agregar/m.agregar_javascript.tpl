...
function save_borrador(){
	var params = '&titulo=' + encodeURIComponent($('input[name="titulo"]').val()) + '&imagen=' + encodeURIComponent($('input[name="imagen"]').val()) + '&cuerpo=' + encodeURIComponent($('textarea[name="cuerpo"]').bbcode()) + '&tags=' + encodeURIComponent($('input[name="tags"]').val()) + '&categoria=' + encodeURIComponent($('select[name="categoria"]').val());
...
$(document).ready(function(){
	...
	$('input[name=preview]').on('click',function(){
		var error = false;
			...
			if ($('textarea[name=cuerpo]').bbcode().length > 63206) {
			...
			$.ajax({
				...
				data: '&titulo=' + encodeURIComponent($('input[name=titulo]').val()) + '&imagen=' + encodeURIComponent($('input[name=imagen]').val()) + '&cuerpo=' + encodeURIComponent($('textarea[name=cuerpo]').bbcode()),
				success: function(r) {
					mydialog.body(r);
