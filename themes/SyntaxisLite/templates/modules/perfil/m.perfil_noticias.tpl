						...
						<div class="widget clearfix" id="perfil-news">
                            ...
                            <div id="news-content">
                                ...
                                <div class="Story" id="pub_{$p.pub_id}">
                                    <a href="{$tsConfig.url}/perfil/{$p.user_name}" class="Story_Pic"><img alt="{$p.user_name}" src="{$tsConfig.url}/files/avatar/{$p.p_user_pub}.webp"/></a>
                                                ...
                                                <li>
                                                   <ul id="cl_{$p.pub_id}" class="commentList">
                                                        ...
                                                        <li class="ufiItem" id="cmt_{$c.cid}">
                                                            <div class="clearfix">
                                                                <a href="{$tsConfig.url}/perfil/{$c.user_name}" class="autorPic"><img alt="{$c.user_name}" src="{$tsConfig.url}/files/avatar/{$c.c_user}.webp" width="32" height="32"/></a>
                                                ...
                                                <li class="ufiItem">
                                                    <div class="newComment">
                                                        ...
                                                        <div class="formulario" style="display:none">
                                                            <img src="{$tsConfig.url}/files/avatar/{$tsUser->uid}.webp" width="32" height="32"/>
